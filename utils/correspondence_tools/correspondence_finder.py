...
def create_non_correspondences(uv_b_matches, img_b_shape, num_non_matches_per_match=100, img_b_mask=None):
    ...
    uv_b_non_matches_0_flat = uv_b_non_matches[0].contiguous().view(-1, 1).type(dtype_float).squeeze(1)
    uv_b_non_matches_1_flat = uv_b_non_matches[1].contiguous().view(-1, 1).type(dtype_float).squeeze(1)
