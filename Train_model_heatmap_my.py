...
class TrainModelHeatmapMy(Train_model_frontend):
...
if __name__ == "__main__":
    # load config
    filename = "configs/superpoint_phototourism_train_heatmap.yaml"
    import yaml
    ...
    train_agent = TrainModelHeatmapMy(config, device=device)
